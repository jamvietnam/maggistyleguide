...
// Build patternlab
//gulp.task('patternlab', shell.task('patternlab/builder/patternlab_gulp.js'));
//gulp.task('patternlab-css', shell.task('patternlab/builder/patternlab_gulp.js'));
//gulp.task('patternlab-css', shell.task('php patternlab/builder/builder.php -g -c'));
// gulp.loadTasks('patternlab/builder/patternlab_gulp.js');
...
gulp.watch(['styleguide/markup/**/*.html'], ['build']);
gulp.watch(['bower.json', 'assets/manifest.json'], ['build']);
  // gulp.watch([path.source + 'patternlab/source/_data/**/*'], ['patternlab']);
  // gulp.watch([path.source + 'patternlab/source/_patterns/**/*'], ['patternlab']);
  // gulp.watch([path.source + 'patternlab/source/css/**/*'], ['patternlab']);
